...
| **I-03** | **Controlador**                | **Driver H-bridge → Motor de carga** | **Comando de corriente (duty cycle PWM)**               | **Señal PWM desde el microcontrolador hacia un driver H-bridge COTS (p. ej. BTS7960). Sin lazo de corriente en hardware: el lazo de corriente se cierra en software, en el mismo microcontrolador que ejecuta el Controlador (2.4), a partir de la corriente real medida (I-04b).** | **RF-BAN-01**                    |
...
| **I-04b** | **Motor de carga**             | **Controlador**                    | **Corriente real del motor de carga (realimentación del lazo interno)** | **Sensor de corriente (ACS712/INA219, a confirmar) digitalizado, ciclo de control**                   | **RF-BAN-01, RF-INS-03**         |
...
- **Preselección de componentes concretos para I-03/I-04b:** modelo de driver H-bridge (candidato: BTS7960) y de sensor de corriente (candidatos: ACS712, INA219), y plataforma de microcontrolador — a resolver junto con la selección de celda de carga en `06_Seleccion_Actuador_de_Carga.md`, §6.
