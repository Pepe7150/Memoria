...
- ~~Propagación pendiente de los acuerdos de Avance I a RNF, CU y geometría CFD~~ — **Completado** en `03_Requisitos_No_Funcionales.md`, `04_Casos_de_Uso.md` (CU-010), este documento (§2.1) y `04_CFD/01_Casos/01_Geometria_Aleta_Referencia.md` (sección 6 actualizada para reflejar que AoA/deflexión son variables separadas con la geometría de Simpson).
