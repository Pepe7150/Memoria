...
* **Analizar** el estado del arte de los actuadores para superficies de control, los bancos de ensayos y las metodologías de obtención de cargas mediante CFD, con el fin de establecer los requisitos de diseño de la plataforma experimental.
* **Desarrollar** una metodología para obtener y procesar cargas fluidodinámicas mediante simulaciones CFD, generando tablas aerodinámicas utilizables en el banco de ensayos.
* **Diseñar** la arquitectura mecánica, electrónica y de control de la plataforma experimental para aplicar las cargas equivalentes sobre actuadores de superficies de control.
* **Implementar** el software de procesamiento e integración encargado de interpretar las tablas de carga y suministrar las referencias necesarias para la ejecución de los ensayos.
* **Construir e instrumentar** el banco de ensayos, incorporando los sensores y sistemas de adquisición de datos necesarios para la caracterización experimental de los actuadores.
* **Validar** la plataforma experimental mediante ensayos con actuadores de superficies de control, evaluando su capacidad para reproducir las cargas objetivo y generar información útil para el dimensionamiento.
