...
Diseñar e implementar un banco de ensayos para la **verificación** y caracterización de actuadores **COTS** de superficies de control utilizando cargas fluidodinámicas obtenidas mediante simulación **Computacional**.

## 5. Objetivos específicos

* **Concebir** un diseño preliminar en base del estado del arte de actuadores, bancos de ensayo y metodolsogías de simulación computacional relevantes para el proyecto.
...
* **Implementar** el banco de ensayos y **Verificar** la plataforma experimental mediante ensayos de actuadores de superficies de control.
