...
6. **Verificar resistencia mecánica** del brazo de torque y los collares impresos en 3D frente al torque pico (~2 N·m), antes de la validación experimental. **Avance parcial:** primera pasada analítica completada en `09_Verificacion_Mecanica_Brazo_Torque.md` — propone sección cuadrada 14×14 mm en PLA (infill ≥80%, orientación de impresión alineada con la flexión) con margen adecuado frente a carga estática pico y cíclica continua. Pendiente: FEA sobre CAD real, definición del método de fijación de los collares al eje, y ensayo físico de confirmación una vez impresas las piezas.
