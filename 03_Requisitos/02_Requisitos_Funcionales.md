...
| RF-CFD-02 | El sistema deberá validar la estructura y consistencia de las tablas importadas (variables de entrada: Mach, ángulo de ataque, deflexión de superficie; variable de salida: torque de charnela), rechazando o señalando archivos mal formados. | Alta | P | OE-4 |
